...
public class Teste_Contas {
	...
	public static void main(String[] args) {
		...
		Emprestimos emprestimoPessoal = new Emprestimo_Pessoal(cc, 50.000, 0.3, 24);
		Emprestimos creditoVeiculo = new Credito_Veiculo(cc, 85.000, 1.5, 60);
		Emprestimos creditoImobiliario = new Credtio_Imobiliario(cc, 350.000, 0.05, 360);
		Seguros servico = new Seguro_De_Vida(500.000);
